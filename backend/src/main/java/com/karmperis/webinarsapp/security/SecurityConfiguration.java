    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, AuthenticationProvider authenticationProvider)
        ...
        http
                ...
                .authorizeHttpRequests(req -> req
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/webinars/{id}/enroll").hasAuthority("ENROLL_IN_WEBINAR")
                        .requestMatchers(HttpMethod.PUT, "/api/v1/webinars/{id}").hasAuthority("EDIT_WEBINAR")
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/webinars/{id}").hasAuthority("DELETE_WEBINAR")
                        .requestMatchers(HttpMethod.GET, "/api/v1/webinars/{id}").hasAuthority("VIEW_WEBINARS")
